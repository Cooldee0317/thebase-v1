  ...
  return (
    <div className="flex-1 bg-secondary p-8 rounded-md ">
      ...
      <div className="flex justify-between flex-col md:flex-row">
        ...
        <div>
          {" "}
          <img src="/zapIn.png" alt="sticker" className="w-full lg:max-w-[230px] md:max-w-[180px] sm:max-w-[160px]  mx-auto" />
          ...
          <div className="mb-1">
            ...
            <span className="text-[11px] text-right">
              ( Sales tax burns all of the $BF automatically. <br /> The sales
